  ...
  <div class="partnership-form__grid">
    ...
    <div class="partnership-form__grid-cell">
      <label class="text-field">
        ...
        <input class="text-field__input" type="text" name="your-name" value="" data-maska="+ 7 (###) - ### - ## - ##" placeholder="+ 7 (___)  - ___ - __ - __" required>
      </label>
    </div>
    <div class="partnership-form__grid-cell">
      <label class="text-field">
    ...
    <div class="partnership-form__grid-cell partnership-form__grid-cell--full">
      <label class="textarea-field">
        ...
        <textarea class="textarea-field__input" name="your-message" placeholder="Преимущественно работаем с теми, кто может выполнять все работы под ключ" required></textarea>
      </label>
    </div>
  </div>
